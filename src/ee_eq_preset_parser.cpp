...
const std::vector<std::string> kLimiterModeLabels = {"Herm Thin", "Herm Wide", "Herm Tail", "Herm Duck",
                                                     "Exp Thin",  "Exp Wide",  "Exp Tail",  "Exp Duck",
                                                     "Line Thin", "Line Wide", "Line Tail", "Line Duck"};
const std::vector<std::string> kLimiterOversamplingLabels = {
...
const std::vector<std::string> kLimiterDitheringLabels = {"None", "7bit", "8bit", "11bit", "12bit",
                                                          "15bit", "16bit", "23bit", "24bit"};
const std::vector<std::string> kLimiterSidechainLabels = {"Internal", "External", "Link"};
...
auto parse_easy_effects_preset(std::string_view bytes, std::string& error) -> ParsedPreset {
  ...
  preset.mode = validate_label(eq.value("mode", preset.mode), kModeLabels, "mode", error);
  if (!error.empty()) {
    return {};
  }
